...
export const Button: React.FC<ButtonProps> = ({ 
  ...
  const variants = {
    primary: "bg-gradient-to-r from-banana-500 to-orange-600 text-white hover:from-banana-400 hover:to-orange-500 focus:ring-banana-500 shadow-lg shadow-banana-500/20 border border-transparent",
